...
extern class Query {
	...
	@:overload(function (eventType:String, ?successCallback:DataSnapshot -> String -> Void, ?failureCallbackOrContext:Dynamic -> Void,
		?context:Dynamic):Query {
	})
	...
	public function once (eventType:String, ?successCallback:DataSnapshot -> Void, ?failureCallbackOrContext:Dynamic,
		?context:Dynamic):Promise<DataSnapshot>;
