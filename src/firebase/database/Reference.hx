...
extern class Reference extends Query {
    ...
    public function transaction(transactionUpdate:Dynamic->Void, ?onComplete:Dynamic->Bool->DataSnapshot->Void, ?applyLocally:Bool):Promise<{committed:Bool, snapshot: Null<DataSnapshot>}>;
